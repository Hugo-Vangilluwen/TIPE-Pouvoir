...
\begin{figure}[H]
	\begin{center}
		\begin{tabular}{|l|r|r|r|}
			\hline \diagbox[dir=NE]{~~~~~~~~~~~~}{~} & Nombre de sièges & Pourcentage de sièges & Indice de Banzhaf normalisé \\
...
\begin{figure}[H]
	...
	\begin{tabular}{|l|r|r|r|r|}
		\hline \diagbox[dir=NE]{~~~~~~~}{~} & Nombre de sièges & Pourcentage de sièges & Indice de Banzhaf & Indice de Banzhaf réaliste \\
...
\begin{figure}[H]
	...
	\caption{diagramme en camembert représentant les sièges, l'indice de pouvoir de Banzhaf et l'indice de Banzhf réaliste que détient chaque groupe au Parlement Européen}
\end{figure}

Le parti populaire européen joue un rôle centrale dans le Parlement Européen. 

L'indice de Banzhaf réaliste accentue encore entre le PPE et les autres groupe. Ni les partis à sa gauche (310 membres) ni les partis à sa droite (192 membres) n'ont la majorité. Les coalitions gagnantes contiennent donc nécessairement le PPE. 
Au contraire, le S\&D, bien que second groupe en term de nombre de membres, est le deuxième groupe le plus à gauche. Les groupe des Verts/ALE aux ENS peuvent facilement former des coalitions sans le S\&D. Son indice de Banzhaf réaliste est ainsi faible.
De même, les groupes GUE/NGL et ENS situés aux extrémités du Parlement Européen ont un indice de Banzhaf nul puisque pour toute coalition gagnante réaliste où ils sont, il y a aussi le PPE ce qui rend ces deux groupes non décisifs.
