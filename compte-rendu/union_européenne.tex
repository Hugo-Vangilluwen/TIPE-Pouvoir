...
J'ai exécuté l'algorithme de Leech en donnant en entrée pour chaque pays le pourcentage de population européenne qu'il possède et un quota de 400. Voici les résultats obtenus avec dans la colonne de droite le nombre de sièges calculé et dans la colonne de gauche celui actuel.
...
On voit clairement un repondération en faveur des petits états.
Cependant, le total de 582 rend difficile de réunir les 400 voix nécessaires. Le Parlement Européen serait alors paralysé. Ce n’est selon nous pas satisfaisant bien que l'algorithme retourne exactement ce qui lui a été demandé.
Ainsi, nous avons besoin de construire un autre système : \hyperlink{section.5}{Penrose62}.
